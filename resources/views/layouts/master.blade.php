      ...
      <div class="container">
         <nav class="bedebe-nav navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                <li><div class="im-plo"><h2>Import Plateform</h2></div></li>         
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{ url('buyer/my-profile') }}"><i class="fa fa-fw fa-user"></i> Edit Profile</a></li>
                        <li><a href="#"><i class="fa fa-fw fa-cog"></i> Change Password</a></li>
                        <li class="divider"></li>
                        <li><a href="{{ route('buyer.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-fw fa-power-off"></i> Logout</a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                  <ul class="navbar-nav mr-auto">
                                        <li class="nav-item active">
                                          <a class="nav-link" href="{{ URL('buyer/dashboard') }}">Hello</a>
                                        </li>
                                        <li class="nav-item">
                                          <a class="nav-link" href="{{ URL('buyer/how-work') }}">How it Work</a>
                                        </li>
                                        <li class="nav-item">
                                          <a class="nav-link" href="{{ URL('buyer/bedebe-shop') }}">My Bedede</a>
                                        </li>
                                        <li class="nav-item">
                                          <a class="nav-link" href="{{ URL('buyer/retailer') }}">Retailers</a>
                                        </li>
                                  </ul>
                            </div>
                        </nav>
