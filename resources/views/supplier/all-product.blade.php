@extends('layouts.exporter_master')
@section('content')
  <div class="content-box my-bedebe">
      <div class="row">
          <div class="col-md-3">
             @include('exporter.sidebar-menu')
          </div>
          <div class="col-md-9">
              <div class="my-bedeeb">
			         ...
			         <table id="mytable" class="table table-bordred table-striped">
			            ...
			            <tbody>
			               ...
			               <tr>
			                 	 ...
			                 	 <td> 
			                 	 	<a href="{{ route('supplier.product.edit',$product->id) }}"><i class="fa fa-pencil"></i></a><span>|</span>
                                     <a href="{{ route('supplier.product.product',$product->id) }}"><i class="fa fa-trash"></i></a>
			                 	 </td>
			               </tr>
			               <?php $count++; ?>
			               @endforeach
